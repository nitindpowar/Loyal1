...
//				R.drawable.black_bar_top));
		...
		if (tabHost != null) {
			...
			if (tabHost.getChildCount() != 2) {
				...
				setupTab(1, mTabsAdapter, tabHost, new TextView(this), "OFFERS",
						CardFragment.class, scheduledBundle);
			}
		}
	}
...
//		showStdCardDialog("Select Card Type");
		...
		Holder.CardHolder.setCardImageName("bigbazar");
	...
	private void showStdCardDialog( String title) {
		...
		AlertDialog.Builder builder = new AlertDialog.Builder(PendingVisitsActivityNew.this);
...
//		cardItems=new ArrayList<CardItem>() ;
		...
		stdCardListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Toast.makeText(PendingVisitsActivityNew.this ,"CardItemPOJO : "+ cardItemPOJO.toString(),Toast.LENGTH_LONG).show();
/*					Intent intent = new Intent(MainActivity.this, CreateCardActivity.class);
				...
				startActivity(intent);
				*/					
				Intent captureIntent= new Intent(PendingVisitsActivityNew.this, CaptureActivity.class);
				startActivityForResult(captureIntent,0);
//				
//				Intent intentN= new Intent(PendingVisitsActivityNew.this,CreateCardActivity.class);
//	        	startActivity(intentN);
